      ...
      <table className={`${styles.table} custom-table`}>
        <thead>
          <tr className={`${styles.tableRow} custom-table-row`}>
            <th className={`${styles.tableHeader} custom-table-header`}>albumId</th>
            <th className={`${styles.tableHeader} custom-table-header`}>id</th>
            <th className={`${styles.tableHeader} custom-table-header`}>title</th>
            <th className={`${styles.tableHeader} custom-table-header`}>url</th>
            <th className={`${styles.tableHeader} custom-table-header`}>thumbnailUrl</th>
          </tr>
        </thead>
        <tbody>
          {data.map((dataObj) => (
            ...
            <tr key={dataObj.id} className={`${styles.tableRow} custom-table-row`}>
              <td className={`${styles.tableData} custom-table-data`}>{dataObj.albumId}</td>
              <td className={`${styles.tableData} custom-table-data`}>{dataObj.id}</td>
              <td className={`${styles.tableData} custom-table-data`}>{dataObj.title}</td>
